...
class Timers extends Homey.App {
    ...
    static startLedring(name) {
        ...
        if (led_start_time > 0) {
            console.log('Starting ledring for timer: ' + led_timer_name);
            return true;    
        }
    ...
    static updateLedring() {
        ...
        if (led_remaining_time > 0) {
            let ledring_percentage = (led_remaining_time * 100 / led_start_time);
            console.log('Start: ' + led_start_time + ', Remaining: ' + led_remaining_time + ', percentage: '+ledring_percentage);
            return true;    
        } else {
            Timers.stopLedring(led_timer_name);
        }
    ...
    static stopLedring(name) {
        ...
        console.log('Stopped ledring for timer: ' + led_timer_name);
